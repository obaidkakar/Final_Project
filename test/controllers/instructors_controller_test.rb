...
class InstructorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create instructor" do
    assert_difference('Instructor.count') do
      post instructors_url, params: { instructor: { Email: @instructor.Email, cell: @instructor.cell, department_id: @instructor.department_id, f_name: @instructor.f_name, ins_name: @instructor.ins_name } }
    end
  ...
  test "should update instructor" do
    patch instructor_url(@instructor), params: { instructor: { Email: @instructor.Email, cell: @instructor.cell, department_id: @instructor.department_id, f_name: @instructor.f_name, ins_name: @instructor.ins_name } }
