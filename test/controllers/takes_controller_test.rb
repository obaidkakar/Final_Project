...
class TakesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create take" do
    assert_difference('Take.count') do
      post takes_url, params: { take: { course_id: @take.course_id, studentt_id: @take.studentt_id } }
    end
  ...
  test "should update take" do
    patch take_url(@take), params: { take: { course_id: @take.course_id, studentt_id: @take.studentt_id } }
